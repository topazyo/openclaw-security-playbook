...
> or `mcp.openclaw.ai` are **environment-specific**. They require external hosted
...
> - Credential scope: `./scripts/forensics/check_credential_scope.sh`
> - Hash verification: `python scripts/forensics/verify_hash_chain.py`
> - Playbook dry-run: `openclaw-cli playbook execute playbook-credential-theft --severity P0 --dry-run`
>
...
## Table of Contents involving OpenClaw/ClawdBot agent credentials, API keys, or authentication tokens.
